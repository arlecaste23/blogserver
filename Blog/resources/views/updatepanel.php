...
<br>
Updating <?php echo '<p id="id" style="visibility:hidden;">'.$article->id.'</p>' ?>
<div class="container">
<p class="w3-margin-top w3-center">Title:</p>
<input id="title" style="text-align:center;background-color: rgba(0,<?php echo rand(50,255)?>,0,0.1);" class="w3-input w3-card w3-margin" type="text" size="35" placeholder='Title here' value='<?php echo base64_decode($article->title); ?>'></input>
<br>
Body:
<br>
 <textarea id="content" style="background-color: rgba(0,<?php echo rand(50,255)?>,0,0.1);" class="w3-input w3-card w3-margin" rows="7" cols="50" placeholder='Insert the content here...'><?php echo base64_decode($article->body); ?>
</textarea> 
<input class="w3-button w3-green w3-round" type="button" value="Done" onclick="save()"></input>
...
<script>
var titlestatus = document.getElementById("title").value;
var bodystatus = document.getElementById("content").value;
function savestatus() {

}
function reset() {
	document.getElementById("title").value = titlestatus;
	document.getElementById("content").value = bodystatus;
}
</script>
</body>
</htm>
