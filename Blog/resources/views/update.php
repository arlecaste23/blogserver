...
<p class="container-fluid w3-card w3-margin w3-center">Update the article</p><br>
<?php
use App\Article;
  ...
  $tt = Article::all();
	...
	echo '	<a href="/update/'.$id.'" style="background-color: rgba(0,0,'.rand(50,255).',0.3);" class="w3-button container w3-margin-bottom w3-card">'.$id.'. '.base64_decode($title).'</a><br>';
...
document.getElementById("bd").onclick = function(event) {
